...
<div class="box box-primary">
 <section class="content-header">
            ...
            Update <?php echo $this->uri->segment(2);?>
                ...
                <form role="form" enctype="multipart/form-data" action="<?php echo base_url();?>save/teacher_update" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label>Profil</label>
                      <textarea name="profil"  class="ckeditor" rows="5" id="ckeditor" placeholder="Profil"><?php echo $t->profil;?></textarea>
                      <script>
                          $(function () {
