                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      foreach ($packages as $p){
                        ...
                        <td>$p->price</td>
                        <td align='center'>
                        <a href='".base_url()."update/packages/$p->id'><span class='label label-success'><i class='fa fa-pencil'></i> Edit</span></a>
                        <a href='".base_url()."delete/packages/$p->id'><span class='label label-danger'><i class='fa fa-trash'></i> Hapus </span></a>
                        </td>
                      </tr>
                     "; } ?>
                    </tbody>
