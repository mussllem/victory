                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      foreach ($founder as $f){
                        ...
                        <td>".$no."</td>
                        <td>$f->nama</td>
                        <td>".substr($f->profil,0,100)."...</td>
                        <td>$f->jobdesk</td>
                        <td align='center'>
                        <a href='".base_url()."update/founder/$f->id'><span class='label label-success'><i class='fa fa-pencil'></i> Edit</span></a>
                        <a href='".base_url()."delete/founder/$f->id'><span class='label label-danger'><i class='fa fa-trash'></i> Hapus </span></a>
                        </td>
                      </tr>
                     "; } ?>
                    </tbody>
