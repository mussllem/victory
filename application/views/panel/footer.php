      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017 <a href="#">victorysriwijayaeducation.com</a>.</strong> All rights reserved.
      </footer>
  ...
  <script>
    ...
    <script src="<?php echo base_url();?>theme/plugins/morris/morris.min.js" type="text/javascript"></script>
   <script src="<?php echo base_url();?>theme/plugins/sparkline/jquery.sparkline.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>theme/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>theme/plugins/jvectormap/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>theme/plugins/knob/jquery.knob.js" type="text/javascript"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>theme/plugins/daterangepicker/daterangepicker.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>theme/plugins/datepicker/bootstrap-datepicker.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>theme/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js" type="text/javascript"></script>
    ...
    <script src="<?php echo base_url();?>theme/dist/js/pages/dashboard.js" type="text/javascript"></script>    
    ...
    <script src="<?php echo base_url();?>theme/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
