                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      foreach ($faq as $f){
                        ...
                        <td>".$no."</td>
                        <td>$f->question</td>
                        <td>".substr($f->answer,0,54)."</td>
                        <td align='center'>
                        <a href='".base_url()."update/faq/$f->id'><span class='label label-success'><i class='fa fa-pencil'></i> Edit</span></a>
                        <a href='".base_url()."delete/faq/$f->id'><span class='label label-danger'><i class='fa fa-trash'></i> Hapus </span></a>
                        </td>
                      </tr>
                     "; } ?>
                    </tbody>
