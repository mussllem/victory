                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      foreach ($teachers as $t){
                        ...
                        <td>".$no."</td>
                        <td>$t->nama</td>
                        <td>".substr($t->profil,0,100)."</td>
                        <td align='center'>
                        <a href='".base_url()."update/teachers/$t->id'><span class='label label-success'><i class='fa fa-pencil'></i> Edit</span></a>
                        <a href='".base_url()."delete/teachers/$t->id'><span class='label label-danger'><i class='fa fa-trash'></i> Hapus </span></a>
                        </td>
                      </tr>
                     "; } ?>
                    </tbody>
