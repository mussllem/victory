                    ...
                    <tbody>
                     <?php
                      ...
                      foreach ($testimoni as $t){
                        ...
                        <td>$t->nama</td>
                        <td>$t->profesi</td>
                        <td>".substr($t->testimoni,0,60)."</td>
                        <td align='center'>
                        <a href='".base_url()."update/testimoni/$t->id'><span class='label label-success'><i class='fa fa-pencil'></i> Edit</span></a>
                        <a href='".base_url()."delete/testimoni/$t->id'><span class='label label-danger'><i class='fa fa-trash'></i> Hapus </span></a>
                        </td>
                      </tr>
                     "; } ?>
                    </tbody>
