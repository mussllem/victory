      ...
      <div class="container">
        <div class="section-content">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="thumb">
                <img class='img-circle' src="<?php echo base_url()?>theme/img/teacher/<?php echo $t->foto;?>" alt="" style="height: 370px; width: 275px;">
              </div>
            </div>
            <div class="col-md-8">
              <h4 class="name font-24 mt-0 mb-0"><?php echo $t->nama;?></h4>
              <h5 class="mt-5">Teacher</h5>
              <p align="justify"><?php echo $t->profil;?></p>
            </div>
          </div>
        <?php endforeach;?>
        </div>
